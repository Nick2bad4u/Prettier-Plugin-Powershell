...
- GitHub Security Advisory draft: <https://github.com/Nick2bad4u/prettier-plugin-powershell/security/advisories/new>
...
- Keep `prettier-plugin-powershell`, ESLint, TypeScript, and dependencies updated.
