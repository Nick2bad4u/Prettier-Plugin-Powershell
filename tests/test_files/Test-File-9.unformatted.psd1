@{
    ...
    Categories =
        @{
            ...
            Logos =
                @( 'arch', 'debian', 'manjaro', 'kaisen', 'us-tuxedomask-1' )
            Patterns =
                @(
                    'bars',
                    'colorbars',
            ...
            RGB =
                @( 'RGB-Wave', 'RGB-Wave-Shifted', 'Gradient-Tiles', 'Galaxy' )
            Welcome = @( 'welcome-Bears2', 'welcome-cats' )
            default = @( '00default', 'crunch', 'zwaves' )
            AutoCategorized = @()
            Custom =
                @(
                    '67-acid',
    ...
    Tags =
        @{
            'mandelbrot-zoom' =
                @( 'Fractal', 'Featured', 'HighDetail', 'Mathematical' )
            ...
            'nerd-font-test' =
                @( 'NerdFont', 'Glyphs', 'Verification', 'System' )
            ...
            'terminal-halloween' =
                @( 'Terminal', 'Theme', 'Halloween', 'Seasonal' )
            ...
            'mandala-pattern' =
                @( 'Mandala', 'Symmetry', 'Artistic', 'Spiritual' )
            ...
            'penrose-quasicrystal' =
                @( 'Quasicrystal', 'Geometric', 'Aperiodic' )
            ...
            'blocktronics-wtf4-megajoint-3' =
                @( 'Abstract', 'ANSI', 'Art', 'Blocktronics' )
            ...
            'geometric-tessellation' =
                @( 'Geometric', 'Tessellation', 'Complex' )
    ...
    Descriptions =
        @{
            'mandelbrot-zoom' =
                'Animated dive into the Mandelbrot set rendered with rich ANSI gradients.'
            'aurora-bands' =
                'Waves of aurora-inspired color emitted with layered gradient passes.'
            'rainbow-spiral' =
                'Cycling rainbow spiral that highlights the ANSI 24-bit palette.'
            'hearts' =
                'Simple heart glyph pattern ideal for quick profile previews.'
            'hearts2' = 'Alternative heart pattern with different styling.'
            'bars' =
                'Evenly spaced color bars showcasing RGB intensity across the palette.'
            'galaxy-spiral' =
                'Stunning spiral galaxy visualization with star field backdrop.'
            'nerd-font-test' =
                'Comprehensive Nerd Font glyph sampler for verifying terminal fonts.'
            'colortest' =
                'Full terminal color palette test showing all 256 colors.'
            'colortest-slim' =
                'Compact color test display for quick verification.'
            ...
            'terminal-benchmark' =
                'Performance benchmark for terminal rendering speed.'
            'spectrum' = 'Full color spectrum display.'
            'nerd-font-glyphs' =
                'Collection of useful Nerd Font icons and symbols.'
            'terminal' = 'Default terminal theme with balanced colors.'
            'terminal-rainbow' =
                'PowerShell profile-friendly terminal theme gradient with warm hues.'
            'terminal-fire' =
                'Warm fire-inspired terminal theme with orange and red tones.'
            'terminal-ocean' =
                'Cool-toned PowerShell startup theme inspired by ocean gradients.'
            'terminal-neon' = 'Vibrant neon-colored terminal theme.'
            'terminal-pastel' = 'Soft pastel-colored terminal theme.'
            'terminal-retro' =
                'Retro-styled terminal theme with classic computing aesthetics.'
            ...
            'newton-basins' =
                'Meticulous rendering of Newton fractal basins in ANSI color.'
            'fourier-epicycles' =
                'Animated Fourier series with rotating epicycles.'
            'julia-morphing' = 'Morphing Julia set fractal animation.'
            'clifford-trails' =
                'Chaotic attractor trails from Clifford equations.'
            ...
            'boids-flock' =
                'Emergent flocking behavior simulation (boids algorithm).'
            'nbody-gravity' =
                'N-body gravitational simulation with particle trails.'
            'particle-field' = 'Dynamic particle field with force interactions.'
            'vector-streams' =
                'Animated particle streams flowing along computed vector fields.'
            ...
            'enchanted-forest' =
                'Mystical forest scene with atmospheric effects.'
            ...
            'mandala-pattern' =
                'Symmetric mandala rendering with layered rings and highlights.'
            ...
            'rainbow-waves' =
                'Smooth sine-wave gradients cycling through rainbow tones.'
            'prismatic-rain' =
                'Prismatic rainfall effect with color dispersion.'
            ...
            'terminal-rainbow-wave' =
                'Rainbow terminal theme with wave animation.'
            ...
            'domain-warp-aurora' =
                'Aurora with domain warping effect for distortion.'
            '67-acid' = 'Abstract acid-inspired ANSI artwork.'
            'alpha-king-ill-form-the-head' =
                'Custom ANSI art piece by Alpha King.'
            'alpha-king-tangle' =
                'Tangled abstract pattern ANSI art by Alpha King.'
            'ant80s-gwar-tribute-1' =
                'GWAR band tribute ANSI art (part 1 of 3).'
            'ant80s-gwar-tribute-2' =
                'GWAR band tribute ANSI art (part 2 of 3).'
            'ant80s-gwar-tribute-3' =
                'GWAR band tribute ANSI art (part 3 of 3).'
            'avg-elko' = 'ELKO ANSI artwork by AVG.'
            'blocktronics-wtf4-megajoint-3' =
                'Blocktronics WTF4 Megajoint pack artwork (part 3).'
            ...
            'cybercatgirl-i' =
                'Cyberpunk catgirl character artwork (variant I).'
            'cybercatgirl-ii' =
                'Cyberpunk catgirl character artwork (variant II).'
